...
const inactiveRoleError = createError('inactiveRoleError', { message: 'Your account is inactive.  Contact the language programs to reactivate your account'});

module.exports = { AuthorizationError, noInputError, noRoleError, inactiveRoleError };