    ...
    <>
      <Grid textAlign="center" verticalAlign="top">
        <Grid.Column style={{ maxWidth: 750 }} textAlign="center">
          ...
          <Grid.Row>
            <Segment>
              <Header as="h3">Build the Required Metadata</Header>
              <Formik
                initialValues={{
                  id: null,
                  originalTitle: "",
                    ...
                    <Grid centered>
                        ...
                        <Grid.Column width={10}>
                          <Dropdown
                            ...
                            options={[
                              ...
                              {
                                key: "findLang",
                                text: "Find a Language",
                                value: "findLang",
                              },
                            ]}
                          />
                          {errors.coverageLang && touched.coverageLang && (
                            <div className="input-feedback">
                              {errors.coverageLang}
                            </div>
                          )}
                      ...
                      <Grid.Row>
                        ...
                        <Grid.Column width={10}>
                          ...
                          />
                          {errors.coverageTime && touched.coverageTime && (
                            <div className="input-feedback">
                              {errors.coverageTime}
                            </div>
                          )}
                      ...
                      <Grid.Row>
                        ...
                        <Grid.Column width={10}>
                          ...
                          />
                          {errors.more && touched.more && (
                            <div className="input-feedback">{errors.more}</div>
                          )}
                        </Grid.Column>
                      </Grid.Row>
                      <Grid.Row>
