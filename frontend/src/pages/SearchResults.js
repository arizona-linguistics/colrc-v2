...
function SearchResults(props) {
  ...
  let {
    loading: affixTypesLoading,
    error: affixTypesError,
    data: affixTypesData,
      ...
      <Grid>
        <Grid.Column width="16">
          <Grid.Row>
            ...
            <Message>
              Use the the filters in each table to refine your search, or{" "}
              <Link to="/search">create a new search</Link>!
            </Message>
          </Grid.Row>
          <Segment>
            <Grid.Row>
          ...
          <Segment>
            <Grid.Row>
              ...
              <AffixTable
                selectValues={selectAffixValues}
          ...
          user &&
          intersectionWith(
            path_odinson_permissions["searchResults"],
            user.roles,
            isEqual
          ).length >= 1 ? (
            <Segment>
