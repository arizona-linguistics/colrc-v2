...
let addUserSchema = Yup.object().shape({
  ...
  email: Yup.string()
    ...
    .required("Required"),
  roles: Yup.string().required("Assign one or more roles"),
  password: Yup.string()
    .trim()
      ...
      <Grid centered>
        <Grid.Row>
          <Grid.Column textAlign="center" width={12}>
            ...
            <Message>
              Use this form to add a new authorized account. The password you
              set should be changed by the user.
            </Message>
          </Grid.Column>
        </Grid.Row>
      </Grid>
