                        ...
                        <Formik 
                            ...
                            <Form>
                                <Grid centered>
                                    ...
                                    <Grid.Row>
                                        <Grid.Column width={2} textAlign="right"><Label pointing="right" color="blue">Type</Label></Grid.Column>
                                        <Grid.Column width={10}>
                                        <Dropdown
                                            id="type"
                                            ...
                                            fluid
                                            multiple
                                            options={[{key: 'fieldnotes', text: 'fieldnotes', value: 'fieldnotes'}, {key: 'workbook', text: 'workbook', value: 'workbook'}, {key: 'audio', text: 'audio', value: 'audio'}]}
