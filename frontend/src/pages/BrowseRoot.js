...
function BrowseRootTable(props) {
  ...
  if (root === "q%") {
    ...
    where = {
      _and: [{ root: { _ilike: "q'%" } }, { root: { _nilike: "q'ʷ%" } }],
    };
  } else if (root === "c%") {
    where = {
      _and: [{ root: { _ilike: "c%" } }, { root: { _nilike: "c'%" } }],
    };
  } else if (root === "č%") {
    where = {
      _and: [{ root: { _ilike: "č%" } }, { root: { _nilike: "č'%" } }],
    };
  } else if (root === "k%") {
    where = {
      _and: [
    ...
    where = {
      _and: [{ root: { _ilike: "l%" } }, { root: { _nilike: "l'%" } }],
    };
  } else if (root === "m%") {
    where = {
      _and: [{ root: { _ilike: "m%" } }, { root: { _nilike: "m'%" } }],
    };
  } else if (root === "n%") {
    where = {
      _and: [{ root: { _ilike: "n%" } }, { root: { _nilike: "n'%" } }],
    };
  } else if (root === "p%") {
    where = {
      _and: [{ root: { _ilike: "p%" } }, { root: { _nilike: "p'%" } }],
    };
  } else if (root === "t%") {
    where = {
      _and: [{ root: { _ilike: "t%" } }, { root: { _nilike: "t'%" } }],
    };
  } else if (root === "w%") {
    where = {
      _and: [{ root: { _ilike: "w%" } }, { root: { _nilike: "w'%" } }],
    };
  } else if (root === "x̣%") {
    where = {
      _and: [{ root: { _ilike: "x̣%" } }, { root: { _nilike: "x̣ʷ%" } }],
    };
  } else if (root === "y%") {
    where = {
      _and: [{ root: { _ilike: "y%" } }, { root: { _nilike: "y'%" } }],
    };
  } else if (root === "ʕ%") {
    where = {
      _and: [{ root: { _ilike: "ʕ%" } }, { root: { _nilike: "ʕʷ%" } }],
    };
  } else {
  ...
  return (
    <>
      <Message>
        <Header as="h4">
          Browsing roots beginning with '{label}' |{" "}
          <Link to={{ pathname: "/roots" }}>Return to full table</Link>
        </Header>
      </Message>
      <TableStyles>
        <Table
